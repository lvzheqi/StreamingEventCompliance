...
class ClientLogging:
    ...
    def log_info(self, func_name, message):
        ...
        :param func_name: :`string` the name of the function from where this logging event was called
    ...
    def log_info(self, func_name, username, message):
        ...
        :param  func_name: :`string` the name of the function from where this logging event was called.
        :param  username: :`string` the username of the user that has initiated the client
        :param  message: :`string` user defined custom messages
        """
        message = "'" + message + "'"
    ...
    def log_info(self, func_name, username, case_id, activity, message):
        ...
        :param func_name: :`string` the name of the function from where this logging event was called
        :param username: :`string` the username of the user that has initiated the client
        :param case_id: :`string` the case id of  the event being processed
        :param activity: :`string` the activity of the event being processed
        :param message: :`string` user defined custom messages
        """
        message = "'" + message + "'"
    ...
    def log_info(self, func_name, username, thread_id, case_id, activity, message):
        ...
        :param thread_id: :`string` Id of the thread handling the event
