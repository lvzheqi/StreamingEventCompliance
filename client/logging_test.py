...
class TestClientLogging(unittest.TestCase):
    ...
    def test_log_info_2(self):
        ...
        Client_logging().log_info(func_name, "Testing logging info with 2 arguments")
    ...
    def test_log_info_3(self):
        ...
        Client_logging().log_info(func_name, uuid, "Testing logging info with 3 arguments")
        with open(CLIENT_LOG_PATH, 'r') as f:
            lines = f.read().splitlines()
            test_data_in_log_file = lines[-1]
            test_data_in_log_file = ' '.join(test_data_in_log_file.split(' ')[3:])
    ...
    def test_log_info_5(self):
        ...
        Client_logging().log_info(func_name, uuid, dic['case_id'], dic['activity'], "Testing logging info with 5 "
                                                                                   "arguments")
        with open(CLIENT_LOG_PATH, 'r') as f:
            lines = f.read().splitlines()
            test_data_in_log_file = lines[-1]
    ...
    def test_log_info_6(self):
        ...
        Client_logging().log_info(func_name, uuid, thread_id, dic['case_id'], dic['activity'], "Testing logging info with 6 "
                                                                                   "arguments")
        with open(CLIENT_LOG_PATH, 'r') as f:
            lines = f.read().splitlines()
            test_data_in_log_file = lines[-1]
    ...
    def test_log_error_2(self):
        ...
        Client_logging().log_error(func_name, "Testing logging error with 2 arguments")
        with open(CLIENT_LOG_PATH, 'r') as f:
            lines = f.read().splitlines()
            test_data_in_log_file = lines[-1]
            test_data_in_log_file = ' '.join(test_data_in_log_file.split(' ')[3:])
    ...
    def test_log_error_3(self):
        ...
        Client_logging().log_error(func_name, uuid, "Testing logging error with 3 arguments")
        with open(CLIENT_LOG_PATH, 'r') as f:
            lines = f.read().splitlines()
            test_data_in_log_file = lines[-1]
            test_data_in_log_file = ' '.join(test_data_in_log_file.split(' ')[3:])
    ...
    def test_log_error_5(self):
        ...
        Client_logging().log_error(func_name, uuid, dic['case_id'], dic['activity'], "Testing logging error with 5 "
                                                                                    "arguments")
        with open(CLIENT_LOG_PATH, 'r') as f:
            lines = f.read().splitlines()
            test_data_in_log_file = lines[-1]
    ...
    def test_log_error_6(self):
        ...
        Client_logging().log_error(func_name, uuid, thread_id, dic['case_id'], dic['activity'],
