...
import threading
from streaming_event_compliance.objects.threadpool.threadpool import ThreadPoolManager,ThreadManager
...
#                 try:
#                     # thread = ThreadManager((case_thread_cc.compliance_check_run, *(event, threads_index, client_uuid, )),
#                     #                        self.error_queue)
#                     # thread.start()
#                     thread_pool.add_job(case_thread_cc.compliance_check_run, *(event, threads_index, client_uuid, ))
#                     # thread.start()
