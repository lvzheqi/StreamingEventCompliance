...
class DBToolsTest(unittest.TestCase):
    ...
    def test_alert_log(self):
        ...
        alog2.add_alert_record(alertlog.AlertRecord(uuid, 'A,C', 'B,D', 1))
        alog2.add_alert_record(alertlog.AlertRecord(uuid, 'A,C', 'B,R', 1))
        alog2.add_alert_record(alertlog.AlertRecord(uuid, 'A,W', 'B,W', 1))
        alog3.add_alert_record(alertlog.AlertRecord(uuid, 'A,A,W', 'B,S,S', 1))
        alog4.add_alert_record(alertlog.AlertRecord(uuid, 'A,L,K,K', 'B,S,S,D', 1))
